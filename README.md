...
A tool for modifying Little Sound Dj (LSDj) ROM images. It allows changing sample kits and palettes. Requires Java (http://www.java.com/). If you have problems running the .jar on Windows, try Jarfix (http://johann.loefflmann.net/en/software/jarfix/index.html)
