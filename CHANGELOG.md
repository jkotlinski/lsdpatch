...
## Unreleased
### Fixed
 - Palette Editor: Updated color correction to match Sameboy 0.15.4 "Modern - Balanced" and "Harsh Reality" settings. Renamed color space settings to hopefully make them easier to understand.
